...
- возможность закрепить выбранный топик для автоматического открытия вместе с чатом;
- собственное оформление и иконка Frogram X;
- автоматическая сборка ARM64 APK через GitHub Actions.
