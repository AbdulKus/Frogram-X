...
android {
  ...
  androidComponents.beforeVariants { variantBuilder ->
    ...
    variantBuilder.enable = sdkVariant.minSdk >= abiVariant.minSdk &&
      ...
      (variantBuilder.buildType != "debug" || sdkVariant.flavor == "legacy" || (abiVariant.flavor == "arm64" || abiVariant.flavor == "x86" || abiVariant.flavor == "x64" || abiVariant.flavor == "universal"))
  }
  productFlavors {
